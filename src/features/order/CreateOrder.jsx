        ...
        <div>
          ...
          <div>
            <input
              ...
              name="address"
              required
              className="placeholder:text-stione-400 w-full rounded-full border border-stone-200 px-4 py-2 text-sm transition-all duration-300 focus:outline-none focus:ring focus:ring-yellow-400 md:px-6 md:py-3"
            />
          </div>
        </div>
...
export async function action({ request }) {
  ...
  if (!isValidPhone(order.phone))
    error.phone = "Please give us correct phone numbe.";
